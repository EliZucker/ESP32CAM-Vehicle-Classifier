#ifndef FLIGHT_VEHICLE_CLASSIFIER_ESP_APP_CAMERA_ESP_H_
#define FLIGHT_VEHICLE_CLASSIFIER_ESP_APP_CAMERA_ESP_H_
...
#endif
#endif  // FLIGHT_VEHICLE_CLASSIFIER_ESP_APP_CAMERA_ESP_H_
